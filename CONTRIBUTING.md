...
denoted by adding a comment in the pull request: `LGTM`. However, only currently listed repository owners are counted towards the required majority.


## I'm a maintainer, should I make pull requests too?

Creating a pull request is the preferred option. Only minor changes and/or bugfixes, which do not need discussion, may be pushed to main.
All other changes should be made through a pull request.
