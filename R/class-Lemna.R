...
Lemna_Schmitt <- function(param, init) {
  new("LemnaSchmittScenario",
      ...
      param.low=list(Emax=0,  EC50=0, b=0.1, P_up=0,
                     AperBM=0, Kbm=0,
                 MolWeight=0,
                 k_phot_max=0, k_resp=0, k_loss=0,
                 Tmin=0, Tmax=5, Topt=4, t_ref=4, Q10=0, k_0=0, a_k=0, C_P=0,
                 CP50=0, a_P=0, KiP=0, C_N=0, CN50=0, a_N=0, KiN=0, BM50=0,
                 mass_per_frond=0, BMw2BMd=1),
      param.up=list(Emax=1,   EC50=1000000, b=20, P_up=100,
                    AperBM=100000, Kbm=100000,
                 MolWeight=1000000,
                 k_phot_max=1, k_resp=0.3, k_loss=3,
                 Tmin=40, Tmax=50, Topt=40, t_ref=40, Q10=10, k_0=1000000, a_k=1000000, C_P=10,
                 CP50=10, a_P=20, KiP=1000000, C_N=10, CN50=10, a_N=20, KiN=1000000, BM50=1000000,
                 mass_per_frond=10, BMw2BMd=100),
      endpoints=c("BM","r"),
...
Lemna_SETAC <- function() {
  ...
  new("LemnaSetacScenario",
      ...
      param.low=list(k_photo_max=0, k_loss=0,
                     BM_min=0, T_opt=4,T_min=0, T_max=4 ,
                     Q10=0, T_ref=4,
                     alpha=0.0000000001, beta=0.0000000001, N_50=0, P_50=0,
                     BM_L=1, E_max=0, EC50_int=0,
                     b=0.1, P=0,
                     r_A_DW=100, r_FW_DW=5, r_FW_V=0.5,r_DW_FN=0,
                     K_pw=0,k_met=0),
      param.up=list(k_photo_max=1, k_loss=3,
                     BM_min=0.1, T_opt=40,T_min=40, T_max=50,
                     Q10=10, T_ref=40,
                     alpha=1000, beta=1000, N_50=10, P_50=10,
                     BM_L=10000, E_max=1, EC50_int=1000000,
                     b=20, P=100,
                     r_A_DW=10000, r_FW_DW=50, r_FW_V=1.5,r_DW_FN=0.1,
                     K_pw=100000,k_met=100),
      endpoints=c("BM","r"),
