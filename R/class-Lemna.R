...
Lemna_Schmitt <- function(param, init) {
  new("LemnaSchmittScenario",
      ...
      param.bounds=list(
        Emax=c(0,1),  EC50=c(0,1000000), b=c(0.1,20), P_up=c(0,100),
        AperBM=c(0,100000), Kbm=c(0,100000), MolWeight=c(0,1000000),
        k_phot_max=c(0,1), k_resp=c(0,0.3), k_loss=c(0,3),
        Tmin=c(0,40), Tmax=c(5,50), Topt=c(4,40), t_ref=c(4,40), Q10=c(0,10),
        k_0=c(0,1000000), a_k=c(0,1000000), C_P=c(0,10), CP50=c(0,10),
        a_P=c(0,20), KiP=c(0,1000000), C_N=c(0,10), CN50=c(0,10), a_N=c(0,20),
        KiN=c(0,1000000), BM50=c(0,1000000), mass_per_frond=c(0,10),
        BMw2BMd=c(1,100)
      ),
      endpoints=c("BM","r"),
...
Lemna_SETAC <- function() {
  ...
  new("LemnaSetacScenario",
      ...
      param.bounds=list(k_photo_max=c(0,1), k_loss=c(0,3), BM_min=c(0,0.1),
                        T_opt=c(4,40),T_min=c(0,40), T_max=c(4,50) , Q10=c(0,10),
                        T_ref=c(4,40), alpha=c(1e-10,1000), beta=c(1e-10,1000),
                        N_50=c(0,10), P_50=c(0,10), BM_L=c(1,10000), E_max=c(0,1),
                        EC50_int=c(0,1e6), b=c(0.1,20), P=c(0,100),
                        r_A_DW=c(100,10000), r_FW_DW=c(5,50), r_FW_V=c(0.5,1.5),
                        r_DW_FN=c(0,0.1), K_pw=c(0,1e5), k_met=c(0,100)),
      endpoints=c("BM","r"),
