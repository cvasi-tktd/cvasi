...
test_that("SD: parameters", {
  ...
  # Non-scaled Ci
  #
  expect_equal(GUTS_SD(scaled_ci=FALSE, dose_metric="D")@param.req,
               c("ki", "ke", "kr", "kk", "hb", "z"))
  expect_equal(GUTS_SD(scaled_ci=FALSE, dose_metric="Ci")@param.req,
               c("ki", "ke", "kk", "hb", "z"))
  expect_equal(GUTS_SD(scaled_ci=FALSE, dose_metric="Cw")@param.req,
               c("kk", "hb", "z"))

  #
  # Scaled Ci
  #
  expect_equal(GUTS_SD(scaled_ci=TRUE, dose_metric="D")@param.req,
               c("ke", "Kiw", "kr", "kk", "hb", "z"))
  expect_equal(GUTS_SD(scaled_ci=TRUE, dose_metric="Ci")@param.req,
               c("ke", "Kiw", "kk", "hb", "z"))
